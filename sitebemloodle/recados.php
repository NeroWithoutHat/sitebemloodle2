...
<head>
    ...
    <title>Nicholio | Comentários</title>
    <!-- Fonts Google -->
...
<body>
                ...
                <div class="row col-12 p-5">
                    ...
                    <div class="col-1 col-sm-8 collapse flex-row-reverse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="recados-form.html">Contato</a>
                            </li>                  
                        </ul> 
                    </div>
                </div>            
    ...
    <main> 
        <section id="lista-recados">
            ...
            <div class="container">                
            <h1>Meus recados</h1>
            <p><a href="recados-form.html">Clique aqui</a> para deixar o seu comentário</p><br>
            </div>
            <?php
